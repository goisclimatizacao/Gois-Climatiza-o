...
export const LoadingSpinner: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center text-gray-500 py-10">
      ...
      <h3 className="text-lg font-semibold text-gray-700">A IA está criando...</h3>
      <p className="text-sm">Isso pode levar alguns segundos. Estamos gerando a imagem e a legenda perfeitas para você.</p>
    </div>
  );
};
